const abi = JSON.stringify([
  ...
  },
  {
    ...
    name: "SwitchToManualSendOFNFTRewards",
    outputs: [
      {
        internalType: "bool",
        name: "",
